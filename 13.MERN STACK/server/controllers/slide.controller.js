...
const deleteSlide = (req, res) => {
    ...
    Slide.findById(id, (err, slide) =>{
        ...
        if (fs.existsSync(`./public/resources/uploads/slide/${pathImagen}`)) {
            fs.unlinkSync(`./public/resources/uploads/slide/${pathImagen}`);
        }
                ...
                if (req.files) {
                    //Capturamos el archivo
                        ...
                        archivo.mv(`./public/resources/uploads/slide/${nombreArchivo}`, err => {
                            ...
                            if (fs.existsSync(`./public/resources/uploads/slide/${rutaImagen}`)) {
                                console.log("borramos la antigua imagen");
                                fs.unlinkSync(`./public/resources/uploads/slide/${rutaImagen}`);
                            }
...
//funcion get para tener acceso a las imagenes
let showImg = (req, res) => {
    let img = req.params.imagen;
    let imgPath = `./public/resources/uploads/slide/${img}`;
