  ...
  const dataArticles = async () => {
    ...
    if (response.status !== 200) {
      ...
      response.articles.forEach((article, index) => {
         dataSet[index] = [ 
          (index + 1),
          [article.portada, article.url],
          article.url,
          article.titulo,
          article.intro,
          article.contenido,
          [article._id + "_", article.url + "_", article.portada + "_",article.titulo + "_", article.intro + "_", article.contenido],
        ];
      });
    }
  // Ejecutamos el Datatable
  $(document).ready(function () {
    let tableArticle = $(".table").DataTable({
      data: dataSet,
      ...
      columns: [
        ...
        { title: "Portada",
          render: function (data) {
            return `<img src="${Config.API_URL}/article/mostrar/${data[1]}/${data[0]}" style="width:320px"/>`;
          },
         },
        { title: "URL" },
        { title: "Titulo" },
        ...
        { title: "Contenido" },
        {
          ...
          render: function (data) {
            return `
							<a href="" class="editIArticle" data-toggle="modal" data-target="#editArticle" data='${data}'>
							...
							<a href="" class="deleteIArticle" data='${data}'>
    ...
    tableArticle.on("order.dt search.dt", function () {
      tableArticle
              ...
              <div className="col-lg-12">
                <div className="card">
                  <div className="card-header">
                    <button className="btn btn-primary float-right cleanForm" data-toggle="modal" data-target="#createArticle">
...
const getArticles = async () => {
  const url = `${Config.API_URL}/article/mostrar`;
