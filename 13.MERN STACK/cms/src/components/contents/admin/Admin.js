...
import EditDeleteAdmin from "./EditDeleteAdmin";
      ...
      columns: [
        ...
        { title: "Usuario" },
        {
          ...
          render: function (data) {
            return `
							<a href="" class="editarInputs" data-toggle="modal" data-target="#editAdmin" data="${data}">
              ...
              <div className="col-lg-12">
                <div className="card">
                  <div className="card-header">
                    <button className="btn btn-primary float-right" data-toggle="modal" data-target="#crearAdmin">
                      Crear nuevo administrador
                    </button>
                  </div>
                  <div className="card-body">
                    <table id="table-admin"
                      className="table-admin table-striped table-bordered dt-responsive"
                      style={{ width: "100%" }}
                    ></table>
                  </div>
                </div>
...
const getAdmin = () => { 
  const url = `${Config.API_URL}/admin/mostrar`;
